...
for arg in "$@"; do
    case "$arg" in
        ...
        *)
            ...
            log_error "Usage: ./cleanup-system.sh [--dry-run]"
            exit 1
            ;;
    esac
done
...
run_remote() {
    ...
    # _cleanup_cleanup_tmpdir is visible after run_remote() returns. This is intentional:
    ...
    trap '_cleanup_cleanup_tmpdir' EXIT ERR INT TERM HUP QUIT
